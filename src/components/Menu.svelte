...
{#if _menu}
  <div class="app">
    <div class="header">
      ...
      <div class="header-menu">
        <a class="menu-link" class:is-active={header_menu == 1} on:click={() => (header_menu = 1)}>Apps</a>
        ...
        <a class="menu-link" class:is-active={header_menu == 4} on:click={() => (header_menu = 4)}>Settings</a>
      </div>
        ...
        <div class="content-wrapper" class:iframe={header_menu == 3}>
            ...
            {#if header_menu == 4}
                <div class="content-section no-margin">
                    <div class="content-section-title">Change your preferences</div>
                    <ul>
                        <li class="adobe-product" on:click={() => toggle_pano2vr_variable("settings_hotspots")}>
                            <div class="products">
                            <!-- <svg viewBox="0 0 52 52" style="border:1px solid #3291b8">
                                <g xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <span class="status">
                            <span class="status-circle" class:green={settings_hotspots} />
                            ...
                            <div class="button-wrapper">
                                <div class="checkbox-wrapper">
                                    <input type="checkbox" id="check1" class="checkbox" bind:checked={settings_hotspots}>
                                    <label for="check1"></label>
                                </div>
                            <!-- <button class="content-button status-button open">Open</button> -->
                            
                            <!-- <div class="menu">
                                <button class="dropdown is-active">
                                <ul>
                                    <li><a href="#">Go to Discover</a></li>
                                    <li><a href="#">Learn more</a></li>
                                    <li><a href="#">Uninstall</a></li>
                        ...
                        <li class="adobe-product" on:click={() => toggle_pano2vr_variable("settings_autorotate")}>
                            <div class="products">
                            <!-- <svg viewBox="0 0 52 52" style="border:1px solid #3291b8">
                                <g xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <span class="status">
                            <span class="status-circle" class:green={settings_autorotate} />
                            {#if settings_autorotate}
                                enabled
                            {:else}
                                disabled
                            {/if}
                            ...
                            <!-- <button class="content-button status-button open">Open</button> -->
                            <div class="checkbox-wrapper">
                                <input type="checkbox" id="check1" class="checkbox" bind:checked={settings_autorotate}>
                                <label for="check1"></label>
                            </div>
                            <!-- <div class="menu">
                                <button class="dropdown is-active">
                        ...
                        <li class="adobe-product" on:click={() => toggle_pano2vr_variable("settings_gyroscope")}>
                            <div class="products">
                            <!-- <svg viewBox="0 0 52 52" style="border:1px solid #3291b8">
                                <g xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <span class="status">
                            <span class="status-circle" class:green={settings_gyroscope} />
                            {#if settings_gyroscope}
                                enabled
                            {:else}
                                disabled
                            {/if}
                            ...
                            <!-- <button class="content-button status-button open">Open</button> -->
                            <div class="checkbox-wrapper">
                                <input type="checkbox" id="check1" class="checkbox" bind:checked={settings_gyroscope}>
                                <label for="check1"></label>
                            </div>
                            <!-- <div class="menu">
                                <button class="dropdown is-active">
                        ...
                        <li class="adobe-product" on:click={() => toggle_pano2vr_variable("settings_sounds")}>
                            <div class="products">
                            <!-- <svg viewBox="0 0 52 52" style="border:1px solid #3291b8">
                                <g xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <span class="status">
                            <span class="status-circle" class:green={settings_sounds} />
                            {#if settings_sounds}
                                enabled
                            {:else}
                                disabled
                            ...
                            <!-- <button class="content-button status-button open">Open</button> -->
                            <div class="checkbox-wrapper">
                                <input type="checkbox" id="check1" class="checkbox" bind:checked={settings_sounds}>
                                <label for="check1"></label>
                            </div>
                            <!-- <div class="menu">
                                <button class="dropdown is-active">
  ...
  <div class="dark-light" on:click={() => toggle_mode()} />
{/if}
