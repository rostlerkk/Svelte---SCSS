  ...
  <div class="app" in:fade out:fade>
    <div class="header">
      ...
      <div class="header-menu">
        <a class="menu-link" class:is-active={header_menu == 1} on:click={() => (header_menu = 1)}>About project</a>
        <a class="menu-link" class:is-active={header_menu == 2} on:click={() => (header_menu = 2)}>About us</a>
        <a class="menu-link" class:is-active={header_menu == 3} on:click={() => (header_menu = 3)}>Our location</a>
        <a class="menu-link" class:is-active={header_menu == 4} on:click={() => (header_menu = 4)}>Weather</a>
      </div>
      ...
      <div class="header-profile">
        ...
        <img
          ...
          alt=""
        /> -->
        <i class="fa-solid fa-sun" class:active={light_mode} on:click={() => toggle_mode()}></i>
        <i class="fa-regular fa-moon" class:active={!light_mode} on:click={() => toggle_mode()}></i>
      </div>
    </div>
    <div class="wrapper">
      <div class="left-side">
        <div class="side-wrapper">
          ...
          <div class="side-menu">
            <a href="#" class:active={left_menu == 10} on:click={() => left_menu = 10}>
              ...
              All Scenes
              <span class="notification-number updates">{scenes_count}</span>
            </a>
            {#each scenes_categories as scene_category}
                <a href="#" class:active={left_menu == scene_category.name} on:click={() => left_menu = scene_category.name}>
                    <i class="fa-solid fa-angle-right"></i>
                    {scene_category.name}
                    <span class="notification-number updates">{scene_category.count}</span>
                </a>
            {/each}
        ...
        <div class="side-wrapper">
          ...
          <div class="side-wrapper">
            <div class="side-title">Share tour</div>
          </div>
        ...
        <!-- <div class="side-wrapper">
          ...
          <div class="side-menu">
            <a href="#" class:active={left_menu == 20} on:click={() => left_menu = 20}>
            ...
            <a href="#" class:active={left_menu == 21} on:click={() => left_menu = 21}>
              <svg viewBox="0 0 512 512" fill="currentColor">
                <circle
                  cx="295.099"
                  cy="327.254"
            ...
            <a href="#" class:active={left_menu == 22} on:click={() => left_menu = 22} >
            ...
            <a href="#" class:active={left_menu == 23} on:click={() => left_menu = 23}>
              <svg viewBox="0 0 512 512" fill="currentColor">
                <path
            ...
            <a href="#" class:active={left_menu == 24} on:click={() => left_menu = 24}>
              <svg viewBox="0 0 512 512" fill="currentColor">
                <path
            ...
            <a href="#" class:active={left_menu == 25} on:click={() => left_menu = 25}>
              <svg viewBox="0 0 512 512" fill="currentColor">
                <path
        ...
        <div class="side-wrapper">
          ...
          <div class="side-menu">
            <a href="#" class:active={left_menu == 30} on:click={() => left_menu = 30}>
        ...
        <div class="side-wrapper">
          ...
          <div class="side-menu">
            <a href="#" class:active={left_menu == 40} on:click={() => left_menu = 40}>
              <svg viewBox="0 0 512 512" fill="currentColor">
                <path
            ...
            <a href="#" class:active={left_menu == 41} on:click={() => left_menu = 41}>
            ...
            <a href="#" class:active={left_menu == 42} on:click={() => left_menu = 42}>
              <svg viewBox="0 0 512 512" fill="currentColor">
                <path
            ...
            <a href="#" class:active={left_menu == 43} on:click={() => left_menu = 43}>
              <svg viewBox="0 0 512 512" fill="currentColor">
                <path
            ...
            <a href="#" class:active={left_menu == 44} on:click={() => left_menu = 44}>
              <svg viewBox="0 0 512 512" fill="currentColor">
                <path
      ...
      <div class="main-container">
        <!-- <div class="main-header">
            {#if header_menu == 3}
                <a class="menu-link-main" href="#">Address : {our_location}
                    </a>
            {/if}
        ...
        <div class="content-wrapper" class:iframe={header_menu == 3}>
            {#if header_menu == 1}
                <div class="content-wrapper-header">
                    <div class="content-wrapper-context">
                    
                    <h3 class="img-content">
                        Nationalpark - Der Zauber der Berge
                    </h3>
                    <div class="content-text">
                        Im Nationalpark Hohe Tauern, dem größten der Alpen, werden Sie Orte entdecken, von denen Sie nicht einmal zu träumen gewagt haben.
                    </div>
                    <button class="content-button">Visit website</button>
                    </div>
            ...
            {/if}
            {#if header_menu == 4}
            <iframe src="https://www.meteoblue.com/en/weather/maps/widget/vienna_austria_2761369?windAnimation=0&gust=0&satellite=0&cloudsAndPrecipitation=0&cloudsAndPrecipitation=1&temperature=0&temperature=1&sunshine=0&extremeForecastIndex=0&geoloc=fixed&tempunit=C&windunit=km%252Fh&lengthunit=metric&zoom=5&autowidth=auto"  frameborder="0" scrolling="NO" allowtransparency="true" sandbox="allow-same-origin allow-scripts allow-popups allow-popups-to-escape-sandbox" style="width: 100%; height: 720px"></iframe><div><!-- DO NOT REMOVE THIS LINK --><a href="https://www.meteoblue.com/en/weather/maps/vienna_austria_2761369?utm_source=weather_widget&utm_medium=linkus&utm_content=map&utm_campaign=Weather%2BWidget" target="_blank" rel="noopener">meteoblue</a></div>
            {/if}

            {#if header_menu == "images-gallery"}
            <p>
...
<div class="menu-icon" on:click={() => menu.update(n=> !n)}>
