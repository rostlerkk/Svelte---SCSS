...
function checkHotspots() {
  ...
  for (var _index2 = 0; _index2 < pointHotspotsNew.length; _index2++) {
    ...
    if (housesValues[lang][houseID][position][_index2 + 1] && housesValues[lang][houseID][position][_index2 + 1] != 'undefined' //housesValues[lang][houseID][position][index+1]['products']['id'] != -1
    ) {
  ...
  if (housesData[lang]) {
    if (!housesData[lang]['additional_content']) {
      if (housesData[lang]['additional_content'][20]) {
        if (housesData[lang]['additional_content'][20]['text']) {
          go_inside = housesData[lang]['additional_content'][20]['text'];
        }
      }

      if (housesData[lang]['additional_content'][21]) {
        if (housesData[lang]['additional_content'][21]['text']) {
          wall_components = housesData[lang]['additional_content'][21]['text'];
        }
      }

      if (housesData[lang]['additional_content'][22]) {
        if (housesData[lang]['additional_content'][22]['text']) {
          house_info = housesData[lang]['additional_content'][22]['text'];
        }
      }

      if (housesData[lang]['additional_content'][25]) {
        if (housesData[lang]['additional_content'][25]['text']) {
          house_info = housesData[lang]['additional_content'][25]['text'];
        }
      }
    }
