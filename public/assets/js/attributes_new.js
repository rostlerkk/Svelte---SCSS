...
function readIds(response, Ids) {
    ...
    console.log(Ids);
    console.log('CSV súbor "Ids" načítaný korenktne');

    // po vytvorení objektu s hodntoami atribútov vytváram objekt s bytmi
...
function readFlats(response, Flats) {
    ...
    for (var i = 1; i < lines.length; i++) {
        ...
        function AddItem() {
            ...
            Flats[_flatID][counter].thumbnails = Ids[_flatAttrID]._attrThumbnails;            
