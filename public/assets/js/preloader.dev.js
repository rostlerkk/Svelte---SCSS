...
!function (a) {
  ...
  a.html5Loader = function (b) {
    var c = {
      ...
      onElementLoaded: function onElementLoaded() {},
    ...
    u.video = function () {
      ...
      try {
        a.canPlayType && (b = {
          ogg: a.canPlayType('video/ogg; codecs="theora"').replace(/^no$/, ""),
          h264: a.canPlayType('video/mp4; codecs="avc1.42E01E"').replace(/^no$/, ""),
          webm: a.canPlayType('video/webm; codecs="vp8, vorbis"').replace(/^no$/, ""),
          vp9: a.canPlayType('video/webm; codecs="vp9"').replace(/^no$/, "")
        }, b.mp4 = b.h264);
      } catch (c) {}
    ...
    var w = function w(b) {
      ...
      return a.each(d, function (a) {
        return u[c][a] ? (b = b.sources[a], b.type = c.toUpperCase(), !1) : void 0;
      }), b.source ? b : !1;
    },
        x = function x() {
      var a = 0;
      ...
      ("VIDEO" === c.type || "AUDIO" === c.type) && (c = w(c)), c && (q += c.size, r.push(c));
        ...
        z = function z(b) {
      v("json loaded"), a(b.files).each(y);
    },
        A = function A(b) {
      ...
      return e.on("load", function () {
        v("File Loaded:" + b.source), p += d, l(b, this), r.splice(0, 1), x(), c.resolve();
      }), e.attr("src", b.source), e = null, c.promise();
    },
        B = function B(b) {
      var c = new a.Deferred(),
          d = b.size,
          ...
          f = function f() {
        v("File Loaded:" + b.source), p += d, l(b, e[0]), r.splice(0, 1), e.off(), e = null, x(), c.resolve();
      };

      return t || s ? f() : (e.on("loadstart", function () {
        ...
        src: b.source,
        controls: "controls"
      }), h && e.on("canplaythrough", f)), c.promise();
    },
        C = function C(b) {
      var c = new a.Deferred(),
          d = b.size,
      ...
      return ("undefined" == typeof b.stopExecution && i || b.stopExecution === !0) && (e.converters = {
        "text script": function textScript(a) {
          return a;
        }
      }), a.ajax(e).done(function (a) {
        v("File Loaded:" + b.source), p += d, l(b, a), r.splice(0, 1), x(), c.resolve();
      }).fail(function (a, c, d) {
      ...
      return a.ajax({
        ...
        success: function success(a) {
          if (v("File Loaded:" + b.source), l(b, a), p += b.size, r.splice(0, 1), x(), c) if (document.createStyleSheet) try {
    ...
    return this.init = function () {
      ...
      var b = new a.Deferred(),
          c = b.promise();
      j(), "object" == _typeof(e) ? (a.proxy(z, this, e)(), b.resolve(e)) : (a.getJSON(e, b.resolve), b.pipe(a.proxy(z, this))), c.then(a.proxy(x, this)), c.then(a.proxy(E, this));
    }, this.init(), this;
  };
}(jQuery);