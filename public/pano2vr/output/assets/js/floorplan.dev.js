...
alert("sgdg"); // tlačidlo Floorplan vo Footri
...
pano.addListener('varchanged_floorplan_full', function () {
  switch (pano.getVariableValue('floorplan_full')) {
    case true:
      ...
      addClass(['.floorplan-full'], 'anim'); //updateComfortLevel();
...
pano.on("changenode", function nodeChange() {
  ...
  if (pano.getVariableValue('floorplan_full')) {//updateComfortLevel();
  }
});