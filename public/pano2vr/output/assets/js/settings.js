...
pano.addListener('varchanged_advertisement', function() {
    ...
    switch (pano.getVariableValue('advertisement')) {
        case true: 
            ...
            $('.switch-container.advertisement > .title').addClass('active');
            //addClass(['.adv-wrapper '],'active');
            ShowElement(['.adv-wrapper']);

        break;
        case false: 
            $('.switch-container.advertisement > .off').addClass('active');
            $('.switch-container.advertisement > .title').removeClass('active');
            //removeClass(['.adv-wrapper '],'active');
