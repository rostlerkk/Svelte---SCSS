...
function playPauseMedia($val) {
  ...
  if (videoDuration == 0 || videoDurationHalf == 0) {
    ...
    pano.getMediaObject(patchName).on('durationchange', function () {//console.log('zmenil sa čas' + pano.getMediaObject(patchName).currentTime);
    });
...
function welcome_screen() {
  ...
  if (housesData[lang]['additional_content'] != undefined) {
    ...
    $('#welcome').remove();
    $('body').append('<div id="welcome">' + '<div id="wrapper">' + '<div id="header">' + '<h1>' + title + '</h1>' + '<h2>' + subtitle + '</h2>' + '<p>' + description + '</p>' + '<div class="buttons">' + '<button id="play_tour">Play</button>' + '<button id="more_info">' + more_info + '</button>' + '</div>' + '</div>' + '<div id="footer">' + '<div id="research" class="item">' + '<div class="thumbnail">' + '<img src="images/btn-1.jpg" />' + '</div>' + '<div class="text">' + '<h4>Research house overview</h4>' + '</div>' + '</div>' + '<div id="rules" class="item">' + '<div class="thumbnail">' + '<img src="images/btn-2.jpg" />' + '</div>' + '<div class="text">' + '<h4>3 Rules of healthy living</h4>' + '</div>' + '</div>' + '<div id="about-viva" class="item">' + '<div class="thumbnail">' + '<img src="images/btn-3.jpg"/>' + '</div>' + '<div class="text">' + '<h4>' + housesData[lang]['additional_content'][23]['title'] + '</h4>' + '</div>' + '</div>' + '<div id="visit-tour" class="item">' + '<div class="thumbnail">' + '<img src="images/00_Free_tour_icon_f.jpg"/>' + '</div>' + '<div class="text">' + '<h4>Visit and enjoy tour</h4>' + '</div>' + '</div>' + '</div>' + '</div>' + '</div>');
...
function houses_screen() {
  ...
  $('body').append('<div id="houses-info-container">' + '<div class="houses-header">' + '<div class="buttons">' + '<img class="play hidden" src="assets/icons/play-houses.svg"/>' + '<img class="pause" src="assets/icons/pause-houses.svg"/>' + '<img class="toggle" src="assets/icons/toggle-houses.svg"/>' + '<button id="next-house">Next house</button>' + '<button id="learn-more" class="learn-more">Learn more about&nbsp;<span>' + houseID + '</span></button>' + '</div>' + '<div class="subtitles">' + '<p>' + current_subtitle + '</p>' + '</div>' + '</div>' + '<div class="houses-footer">' + '<div id="house_1" class="item">' + '<img class="icon" src="images/house-default.png"/>' + '<p>' + house_1 + '</p>' + '</div>' + '<div id="house_2" class="item">' + '<img class="icon" src="images/house-default.png"/>' + '<p>' + house_2_title + '<br>' + house_2_content + '</p>' + '</div>' + '<div id="house_3" class="item">' + '<img class="icon" src="images/house-massive.png"/>' + '<p>' + house_3_title + '<br>' + house_3_content + '</p>' + '</div>' + '<div id="house_4"  class="item">' + '<img class="icon" src="images/house-wooden.png"/>' + '<p>' + house_4_title + '<br>' + house_4_content + '</p>' + '</div>' + '<div id="house_5" class="item">' + '<img class="icon" src="images/house-aerated.png"/>' + '<p>' + house_5_title + '<br>' + house_5_content + '</p>' + '</div>' + '<div id="house_6" class="item">' + '<img class="icon" src="images/house-brick.png"/>' + '<p>' + house_6_title + '<br>' + house_6_content + '</p>' + '</div>' + '</div>' + '</div>');
  changePanoTitle(lang, housesData);
...
function run_baumit_tour() {
      ...
      setTimeout(function () {
        ...
        if (baumit_object[current_node].sequences[i] != null && baumit_object[current_node].sequences[i] != 'undefined') {
          ...
          New_interval = setInterval(function () {
            pano.setMediaVisibility('video_' + i, false);
            pano.pauseSound('video_' + i); //open_next_scene();
  ...
  $('#houses-info-container').remove();
  $('body').append('<div id="houses-info-container" style="display: none;">' + '<div class="houses-header">' + '<div class="buttons">' + '<img class="play hidden" src="assets/icons/play-houses.svg"/>' + '<img class="pause" src="assets/icons/pause-houses.svg"/>' + '<img class="toggle" src="assets/icons/toggle-houses.svg"/>' + '<button id="next-house">Next house</button>' + '<button id="learn-more" class="learn-more">Learn more about&nbsp;<span>' + houseID + '</span></button>' + '</div>' + '<div class="subtitles">' + '<p>' + baumit_object[pano.getCurrentNode()].sequences[1].languages[lang].subtitles + '</p>' + '</div>' + '</div>' + '<div class="houses-footer">' + '<div id="house_1" class="item">' + '<img class="icon" src="images/house-default.png"/>' + '<p>' + house_1 + '</p>' + '</div>' + '<div id="house_2" class="item">' + '<img class="icon" src="images/house-default.png"/>' + '<p>' + house_2_title + '<br>' + house_2_content + '</p>' + '</div>' + '<div id="house_3" class="item">' + '<img class="icon" src="images/house-massive.png"/>' + '<p>' + house_3_title + '<br>' + house_3_content + '</p>' + '</div>' + '<div id="house_4"  class="item">' + '<img class="icon" src="images/house-wooden.png"/>' + '<p>' + house_4_title + '<br>' + house_4_content + '</p>' + '</div>' + '<div id="house_5" class="item">' + '<img class="icon" src="images/house-aerated.png"/>' + '<p>' + house_5_title + '<br>' + house_5_content + '</p>' + '</div>' + '<div id="house_6" class="item">' + '<img class="icon" src="images/house-brick.png"/>' + '<p>' + house_6_title + '<br>' + house_6_content + '</p>' + '</div>' + '</div>' + '</div>');
  ...
  pano.on('varchanged_baumit_tour', function () {
    if (!pano.getVariableValue('baumit_tour')) {
      ...
      change_data(); //console.log(pano.getMediaObject(pano.getNodeUserdata(pano.getCurrentNode()).title).currentTime);
