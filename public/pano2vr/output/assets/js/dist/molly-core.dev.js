...
$.getScript('assets/js/social.min.js'); //$.getScript('assets/js/videopanel.js');
...
'assets/icons/modify_h.svg', 'assets/icons/model_move.svg', 'assets/icons/model_scroll.svg', 'assets/icons/pinch.svg', 'assets/icons/tap_drag.svg', 'assets/icons/check-hlp.svg', 'assets/icons/checked-hlp.svg', 'media/ICON_INT_DOOR_ON.png', 'media/ICON_INT_DOOR_OFF.png', 'media/ICON_INT_INFO_ON.png', 'media/ICON_INT_INFO_OFF.png', 'media/ICON_INT_LAYERS_ON.png', 'media/ICON_INT_LAYERS_OFF.png', 'media/ICON_EXT_DOOR_ON.png', 'media/ICON_EXT_DOOR_OFF.png', 'media/ICON_EXT_INFO_ON.png', 'media/ICON_EXT_INFO_OFF.png', 'media/ICON_EXT_LAYERS_ON.png', 'media/ICON_EXT_LAYERS_OFF.png']).preload();
...
$(window).on('load', function () {
  ...
  if (pano.configloaded = true) {
    setTimeout(function () {
      ...
      pano.setVariableValue('lang', 'uk'); // Aktívna panoráma na floorplane /* Pano2VR BUG*/
    ...
    if ($('.intro')[0]) {} else {
      removeIntro();
      /* funkcia je definovaná vo functions.js*/
    }
  }
});
