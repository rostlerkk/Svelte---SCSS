...
function nacitajData(productName, product_id, position) {
    ...
    if (
        ...
        if (
            ...
            productNameSave = product_id;
            // var key = productNameSave+productSuffix[lang];
            // ////console.log(key);
                ...
                if (
                    ...
                    $.each( val, function (i, data) {
                        ...
                        if (
                            ...
                            let layers_data = ['name','description','image','details_url','product_benefit_1','product_benefit_2','product_benefit_3'];
...
pano.on('configloaded', function(Tooltips) {
    ...
    //loadProductData(housesUrl,lang);
