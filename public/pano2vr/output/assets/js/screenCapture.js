...
var takeScreenShotDiv = '<div class="takeScreenShot" data-html2canvas-ignore="true"><div class="title">Take screenshot</div></div>';
...
function createScreenShot(){
    ...
    // }).then(function(canvas) {
    //     $('.watermark').remove();
    //     $('.screenBlurrNew').prepend($('<img>',{id:'drawingAreaImg',src:'uploads/molly.jpeg'}));
...
function addDownloadButton () {
    ...
    $('.downloadScreenShot').on('click tap', function() {
        // var a = document.createElement('a');
        // var img = $('#drawingAreaImg').attr('src');
        //     a.href = img;
        //     a.download = 'Mollynka.jpeg';
        //     a.click();
