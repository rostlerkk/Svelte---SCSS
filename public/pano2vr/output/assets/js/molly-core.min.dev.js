...
$.getScript('assets/js/floorplan.min.js');
$.getScript('assets/js/global-info.min.js');
$.getScript('assets/js/hlp-layer.min.js'); //$.getScript('assets/js/chatbot.min.js');

$.getScript('assets/js/infopanel.min.js');
$.getScript('assets/js/languages.min.js'); //$.getScript('assets/js/localvideo.js');
...
$.getScript('assets/js/social.min.js');
$.getScript('assets/js/sounds.min.js'); //$.getScript('assets/js/videopanel.js');
...
$(['images/vivapark-logo.svg', //'assets/icons/woow-logo-black.svg',
'assets/icons/apartments_active.svg', 'assets/icons/floorplan_active.svg', 'assets/icons/map_active.svg', //'assets/icons/cart_active.svg',
//'assets/icons/layers_active.svg',
'assets/icons/social_active.svg', 'assets/icons/global-info_active.svg', 'assets/icons/floorplan_active.svg', //'assets/icons/vr_active.svg',
//'assets/icons/chatbot_active.svg',
'assets/icons/checked.svg', 'assets/icons/prev_h.svg', 'assets/icons/sound_off.svg', 'assets/icons/close.svg', 'assets/icons/resize.svg', //'assets/icons/premium.svg',
...
'assets/icons/modify_h.svg', 'assets/icons/model_move.svg', 'assets/icons/model_scroll.svg', 'assets/icons/pinch.svg', 'assets/icons/tap_drag.svg', 'assets/icons/check-hlp.svg', 'assets/icons/checked-hlp.svg', 'media/Patch_ikony_int/ICON_INT_DOOR_ON.png', 'media/ICON_INT_DOOR_OFF.png', 'media/Patch_ikony_int/ICON_INT_INFO_ON.png', 'media/ICON_INT_INFO_OFF.png', 'media/Patch_ikony_int/ICON_INT_LAYERS_ON.png', 'media/ICON_INT_LAYERS_OFF.png', 'media/Patch_ikony_ext/ICON_EXT_DOOR_ON.png', 'media/ICON_EXT_DOOR_OFF.png', 'media/Patch_ikony_ext/ICON_EXT_INFO_ON.png', 'media/ICON_EXT_INFO_OFF.png', 'media/Patch_ikony_ext/ICON_EXT_LAYERS_ON.png', 'media/ICON_EXT_LAYERS_OFF.png', 'media/Patch_ikony_int/Ikony_Dom_08_FINAL/MONITOR_NONACTIVE.png', 'media/Patch_ikony_int/Ikony_Dom_08_FINAL/MONITOR_ACTIVE.png', 'media/Patch_ikony_int/Ikony_Dom_08_FINAL/SOLIDITY_NONACTIVE.png', 'media/Patch_ikony_int/Ikony_Dom_08_FINAL/SOLIDITY_ACTIVE.png', 'media/Patch_ikony_int/Ikony_Dom_08_FINAL/INTERIORVALUES_NONACTIVE.png', 'media/Patch_ikony_int/Ikony_Dom_08_FINAL/INTERIORVALUES_ACTIVE.png', 'media/Patch_ikony_int/Ikony_Dom_08_FINAL/INSULATION_NONACTIVE.png', 'media/Patch_ikony_int/Ikony_Dom_08_FINAL/INSULATION_ACTIVE.png']).preload();
var LftArrow = $('.arrows.lft-arrow');
var RgtArrow = $('.arrows.rgt-arrow'); // Akcie pri zmene hodnoty premennej blurred
...
pano.addListener('varchanged_blurred', function () {
  ...
  switch (pano.getVariableValue('blurred')) {
    case true:
      ...
      variableFalse(['footer_floorplan', 'footer_map', 'footer_layers', 'footer_chatbot', 'footer_social', 'attributes_side', 'attributes_hotspot', 'lang_menu', 'shortcuts', 'mobile_menu_left', 'mobile_menu_right', 'settings', 'footer_apartments', 'new_blur']);
...
$(window).on('load', function () {
  ...
  if (pano.configloaded = true) {
    setTimeout(function () {
      CleanedDivs.removeAttr('style').find('div').removeAttr('style').find('br').remove().removeClass('ggskin ggskin_container ggskin_text clean delete'); // odstráni classy pridané Pano2VR vrátane classy clean a delete.
      ...
      $('.shortcuts-navigation').unwrap(); // Nastavenie Slovenské jazyka /* Pano2VR BUG */
      //pano.setVariableValue('lang', 'int');
      // Aktívna panoráma na floorplane /* Pano2VR BUG*/

      removeClass(['.check-layer'], 'active');
      $('span.active').closest('.check-layer').addClass('active'); // zastavenie autotour po kliku na niektorú z panorám v slidery
    ...
    }, 0); // Ak nie je INTRO súčasťou

    if ($('.intro')[0]) {} else {//removeIntro(); /* funkcia je definovaná vo functions.js*/
    }
  }
